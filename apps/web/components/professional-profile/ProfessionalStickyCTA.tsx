...
export function ProfessionalStickyCTA({ professional, pets }: ProfessionalStickyCTAProps) {
  return (
    <div className="safe-bottom fixed inset-x-0 bottom-[var(--bottom-nav-height)] z-30 border-t border-black/[.07] bg-white/95 px-4 pb-3 pt-3.5 shadow-[0_-8px_24px_-4px_rgba(29,47,111,.12)] backdrop-blur-md lg:hidden">
