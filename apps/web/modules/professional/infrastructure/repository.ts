...
// `DuplicateActiveServiceError` e `isDuplicateActiveServiceViolation` vivem em
// domain/service-uniqueness.ts — são puros (só dependem de tipos do
// @prisma/client, não do client conectado), o que os torna testáveis sem
// banco. Re-exportados aqui para não quebrar os imports existentes em
// professional/application/actions.ts e professional-services/application/actions.ts.
export {
  DuplicateActiveServiceError,
  isDuplicateActiveServiceViolation,
} from "../domain/service-uniqueness"
import { isDuplicateActiveServiceViolation, DuplicateActiveServiceError } from "../domain/service-uniqueness"
